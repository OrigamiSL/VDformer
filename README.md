...
[Variable-Dynamic Multivariate Time Series Forecasting for IoT Systems] (Manuscript submitted to IEEE IOTJ). The appendix of this paper can be found at `./appendix/VDformer_Appendix.pdf.`
